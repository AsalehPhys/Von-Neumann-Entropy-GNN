...
CONFIG = {
    ...
    'save_interval': 150,  # Save intermediate results every 50 chunks
    'num_workers': min(mp.cpu_count() - 1, 40),  # Limit to 8 workers max
...
class ExperimentalSpinSystemDataset(InMemoryDataset):
    ...
    def process(self):
        ...
        try:
            # Filter data based on max_points_per_ny
            filtered_data = []
