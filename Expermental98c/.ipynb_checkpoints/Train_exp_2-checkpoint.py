...
# -----------------------------------------------------------
CONFIG = {
    'processed_dir': './processed_experimentalcc',  
    ...
    'patience': 75,
    'random_seed': 42,
    'best_model_path': 'best_experimental_gnn_98cc.pth',
    'dropout_p': 0.4,
...
class ExperimentalGNN(nn.Module):
    def __init__(
        ...
        self.feature_indices = {
            ...
            'quantum_windows': slice(11, None)  # Window-based quantum features (4 features × 3 windows)
        }
        ...
        # Message Passing layers with enhanced edge processing
        ...
        for i in range(num_layers):
            if i % 2 == 0:
                ...
                conv = GINEConv(mp_mlp, edge_dim=hidden_channels // 2)  # Using transformed edge features
            else:
                conv = TransformerConv(
                    hidden_channels, hidden_channels // 4,
                    heads=4,
                    edge_dim=hidden_channels // 2,  # Using transformed edge features
                    dropout=dropout_p,
                    beta=True
                )
    ...
    def forward(self, data):
        ...
        # Split features using defined indices
        ...
        # Graph-level readouts and final prediction remain the same
